...
contract RewardsManagerHarnessBaraa is
    RewardsManager /*Fixed*/
{
    ...
    function getTotalPoints(uint256 epochId, address vaultAddress)
        public
        returns (uint256)
    {
    ...
    function getLastAccruedTimestamp(uint256 epochId, address vaultAddress)
        public
        returns (uint256)
    {
    ...
    function getLastUserAccrueTimestamp(
        uint256 epochId,
        address vaultAddress,
        address userAddress
    ) public returns (uint256) {
    ...
    function getTotalSupply(uint256 epochId, address vaultAddress)
        public
        returns (uint256)
    {
